...
In this hypothesis volatility rises first, and this causes negative returns (which means /expected/ returns increase).  So this hypothesis works in the opposite direction as the leverage hypothesis. 
